...
function get_grnlines() {
    $.ajax({
        url: "" + api_url + "/v_grnlines",
        type: "GET",
        dataType: "JSON",
        success: function (data) {
            ...
            if (response_type == 'object') {
                ...
                var table = '<table class=" grns_table   table table-striped table-bordered dt-responsive nowrap" id="grns_table" cellspacing="0" width="100%">\n\ <thead>\n\
                                    <tr> <th> No</th>  <th>Description</th> \n\ <th>Batch No </th> <th>Receipt Qty </th> <th>Expiry Date </th>    <th>Action</th> <th>Edit</th> </tr>\n\
                ...
                var no = 1;
                $.each(data, function (value, i) {
                    var i_grnline_id = i.i_grnline_id;
                    var i_grn_id = i.i_grn_id;
                    var receiptqty = i.receiptqty;
                    var batchno = i.batchno;
                    var expirydate = i.expirydate;
...
\n\                 <input type='hidden' name='i_grnline_id' class='form-control i_grnline_id' id='i_grnline_id' value=" + i_grnline_id + ">\n\
