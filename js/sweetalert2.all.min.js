!function (n, e) {
    ...
    var n = {title: "", titleText: "", text: "", html: "", type: null, customClass: "", target: "body", animation: !0, allowOutsideClick: !0, allowEscapeKey: !0, allowEnterKey: !0, showConfirmButton: !0, showCancelButton: !1, preConfirm: null, confirmButtonText: "OK", confirmButtonAriaLabel: "", confirmButtonColor: "#3085d6", confirmButtonClass: null, cancelButtonText: "Cancel", cancelButtonAriaLabel: "", cancelButtonColor: "#aaa", cancelButtonClass: null, buttonsStyling: !0, reverseButtons: !1, focusConfirm: !0, focusCancel: !1, showCloseButton: !1, closeButtonAriaLabel: "Close this dialog", showLoaderOnConfirm: !1, imageUrl: null, imageWidth: null, imageHeight: null, imageAlt: "", imageClass: null, timer: null, width: 500, padding: 20, background: "#fff", input: null, inputPlaceholder: "", inputValue: "", inputOptions: {}, inputAutoTrim: !0, inputClass: null, inputAttributes: {}, inputValidator: null, grow: !1, position: "center", progressSteps: [], currentProgressStep: null, progressStepsDistance: "40px", onBeforeOpen: null, onOpen: null, onClose: null, useRejections: !0}, e = function (n) {
    ...
    }, l = {previousWindowKeyDown: null, previousActiveElement: null, previousBodyPadding: null}, c = function (n) {
        var e = d();
        e && e.parentNode.removeChild(e);
        {
            if ("undefined" != typeof document) {
                ...
                var a = p(), r = L(a, t.input), i = L(a, t.file), l = a.querySelector("." + t.range + " input"), c = a.querySelector("." + t.range + " output"), f = L(a, t.select), w = a.querySelector("." + t.checkbox + " input"), m = L(a, t.textarea);
        ...
        return w(t.progresssteps)
    }, x = function () {
        return w(t.validationerror)
    }, y = function () {
        return w(t.confirm)
    }, v = function () {
        return w(t.cancel)
    }, k = function () {
        return w(t.buttonswrapper)
    }, C = function () {
        return w(t.close)
    }, S = function () {
        ...
        var n = document.createElement("div"), e = {WebkitAnimation: "webkitAnimationEnd", OAnimation: "oAnimationEnd oanimationend", animation: "animationend"};
        for (var t in e)
            if (e.hasOwnProperty(t) && void 0 !== n.style[t])
                return e[t];
        return!1
    }(), z = function () {
        if (window.onkeydown = l.previousWindowKeyDown, l.previousActiveElement && l.previousActiveElement.focus) {
            var n = window.scrollX, e = window.scrollY;
        ...
        function e(e) {
            ...
            this._invoke = function (n, e) {
                return new Promise(function (o, i) {
                    var s = {key: n, arg: e, resolve: o, reject: i, next: null};
    ...
    var K = function (n) {
        ...
        var e = void 0, a = p(), r = "string" == typeof n.target ? document.querySelector(n.target) : n.target;
        ...
        for (var u = e.querySelectorAll("[class^=swal2-success-circular-line], .swal2-success-fix"), w = 0; w < u.length; w++)
            u[w].style.background = n.background;
        var x = d(), S = m(), A = g(), B = k(), L = y(), H = v(), O = C();
        if (n.titleText ? S.innerText = n.titleText : S.innerHTML = n.title.split("\n").join("<br />"), n.text || n.html) {
            if ("object" === I(n.html))
                if (A.innerHTML = "", 0 in n.html)
                    for (var z = 0; z in n.html; z++)
                        A.appendChild(n.html[z].cloneNode(!0));
                else
                    A.appendChild(n.html.cloneNode(!0));
            else
                n.html ? A.innerHTML = n.html : n.text && (A.textContent = n.text);
            T(A)
        } else
            q(A);
        if (n.position in t && E(x, t[n.position]), n.grow && "string" == typeof n.grow) {
            var M = "grow-" + n.grow;
            M in t && E(x, t[M])
        }
        n.showCloseButton ? (O.setAttribute("aria-label", n.closeButtonAriaLabel), T(O)) : q(O), e.className = t.modal, n.customClass && E(e, n.customClass);
        var N = b(), R = parseInt(null === n.currentProgressStep ? X.getQueueStep() : n.currentProgressStep, 10);
        n.progressSteps.length ? (T(N), V(N), R >= n.progressSteps.length && i("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"), n.progressSteps.forEach(function (e, o) {
            var a = document.createElement("li");
            if (E(a, t.progresscircle), a.innerHTML = e, o === R && E(a, t.activeprogressstep), N.appendChild(a), o !== n.progressSteps.length - 1) {
                var r = document.createElement("li");
                E(r, t.progressline), r.style.width = n.progressStepsDistance, N.appendChild(r)
            }
        })) : q(N);
        for (var D = f(), U = 0; U < D.length; U++)
            q(D[U]);
        if (n.type) {
            var W = !1;
            for (var K in o)
            ...
            if (!W)
                return s("Unknown alert type: " + n.type), !1;
            var $ = e.querySelector("." + t.icon + "." + o[n.type]);
            if (T($), n.animation)
                switch (n.type) {
                    case"success":
                        E($, "swal2-animate-success-icon"), E($.querySelector(".swal2-success-line-tip"), "swal2-animate-success-line-tip"), E($.querySelector(".swal2-success-line-long"), "swal2-animate-success-line-long");
                        break;
                    case"error":
                        E($, "swal2-animate-error-icon"), E($.querySelector(".swal2-x-mark"), "swal2-animate-x-mark")
                    }
        }
        var _ = h();
        n.imageUrl ? (_.setAttribute("src", n.imageUrl), _.setAttribute("alt", n.imageAlt), T(_), n.imageWidth ? _.setAttribute("width", n.imageWidth) : _.removeAttribute("width"), n.imageHeight ? _.setAttribute("height", n.imageHeight) : _.removeAttribute("height"), _.className = t.image, n.imageClass && E(_, n.imageClass)) : q(_), n.showCancelButton ? H.style.display = "inline-block" : q(H), n.showConfirmButton ? j(L, "display") : q(L), n.showConfirmButton || n.showCancelButton ? T(B) : q(B), L.innerHTML = n.confirmButtonText, H.innerHTML = n.cancelButtonText, L.setAttribute("aria-label", n.confirmButtonAriaLabel), H.setAttribute("aria-label", n.cancelButtonAriaLabel), n.buttonsStyling && (L.style.backgroundColor = n.confirmButtonColor, H.style.backgroundColor = n.cancelButtonColor), L.className = t.confirm, E(L, n.confirmButtonClass), H.className = t.cancel, E(H, n.cancelButtonClass), n.buttonsStyling ? (E(L, t.styled), E(H, t.styled)) : (P(L, t.styled), P(H, t.styled), L.style.backgroundColor = L.style.borderLeftColor = L.style.borderRightColor = "", H.style.backgroundColor = H.style.borderLeftColor = H.style.borderRightColor = ""), !0 === n.animation ? P(e, t.noanimation) : E(e, t.noanimation), n.showLoaderOnConfirm && !n.preConfirm && i("showLoaderOnConfirm is set to true, but preConfirm is not defined.\nshowLoaderOnConfirm should be used together with preConfirm, see usage example:\nhttps://limonte.github.io/sweetalert2/#ajax-request")
    }, $ = function (n, e, o) {
        var a = d(), r = p();
        null !== e && "function" == typeof e && e(r), n ? (E(r, t.show), E(a, t.fade), P(r, t.hide)) : P(r, t.fade), T(r), a.style.overflowY = "hidden", O && !A(r, t.noanimation) ? r.addEventListener(O, function n() {
            r.removeEventListener(O, n), a.style.overflowY = "auto"
        }) : a.style.overflowY = "auto", E(document.documentElement, t.shown), E(document.body, t.shown), E(a, t.shown), _(), Q(), l.previousActiveElement = document.activeElement, null !== o && "function" == typeof o && setTimeout(function () {
            o(r)
        })
    }, _ = function () {
        null === l.previousBodyPadding && document.body.scrollHeight > window.innerHeight && (l.previousBodyPadding = document.body.style.paddingRight, document.body.style.paddingRight = M() + "px")
    }, Z = function () {
        ...
        return new Promise(function (e, o) {
            ...
            for (var w = function (t) {
                ...
                var r = t || window.event, s = r.target || r.srcElement, l = y(), c = v(), u = l && (l === s || l.contains(s)), d = c && (c === s || c.contains(s));
                switch (r.type) {
                    case"mouseover":
                    case"mouseup":
                        ...
                        if (u && n.isVisible())
                            if (n.disableButtons(), i.input) {
                                ...
                                i.inputValidator ? (n.disableInput(), i.inputValidator(p, i.extraParams).then(function () {
                                    n.enableButtons(), n.enableInput(), w(p)
                                }, function (e) {
                            ...
                            d && n.isVisible() && (n.disableButtons(), n.closeModal(i.onClose), i.useRejections ? o("cancel") : e({dismiss: "cancel"}))
                    }
            }, V = u.querySelectorAll("button"), j = 0; j < V.length; j++)
                V[j].onclick = A, V[j].onmouseover = A, V[j].onmouseout = A, V[j].onmousedown = A;
            C().onclick = function () {
            ...
            var O = k(), z = y(), M = v();
            i.reverseButtons ? z.parentNode.insertBefore(M, z) : z.parentNode.insertBefore(z, M);
            var R = function (n, e) {
                ...
                if ("Enter" === a.key)
                    a.target === r() && (n.clickConfirm(), a.preventDefault());
                else if ("Tab" === a.key) {
                    ...
                    ["ArrowLeft", "ArrowRight", "ArrowUp", "Arrowdown"].includes(a.key) ? document.activeElement === z && H(M) ? M.focus() : document.activeElement === M && H(z) && z.focus() : "Escape" === a.key && !0 === i.allowEscapeKey && (n.closeModal(i.onClose), i.useRejections ? o("esc") : e({dismiss: "esc"}))
            };
            window.onkeydown && window.onkeydown.toString() === D.toString() || (l.previousWindowKeyDown = window.onkeydown, window.onkeydown = D), i.buttonsStyling && (z.style.borderLeftColor = i.confirmButtonColor, z.style.borderRightColor = i.confirmButtonColor), n.hideLoading = n.disableLoading = function () {
                i.showConfirmButton || (q(z), i.showCancelButton || q(k())), P(O, t.loading), P(u, t.loading), u.removeAttribute("aria-busy"), z.disabled = !1, M.disabled = !1
            }, n.getTitle = function () {
                return m()
                ...
                z.disabled = !1, M.disabled = !1
            }, n.disableButtons = function () {
                z.disabled = !0, M.disabled = !0
                ...
                if (!n)
                    return!1;
                if ("radio" === n.type)
                    for (var e = n.parentNode.parentNode.querySelectorAll("input"), t = 0; t < e.length; t++)
                        e[t].disabled = !1;
                else
                    n.disabled = !1
                ...
                if (n && "radio" === n.type)
                    ...
                    n.disabled = !0
            }, n.recalculateHeight = N(function () {
                var n = p();
                if (n) {
            ...
            switch (i.input) {
                ...
                case"file":
                    ...
                    break;
                case"range":
                    var nn = L(u, t.range), en = nn.querySelector("input"), tn = nn.querySelector("output");
                ...
                case"select":
                    ...
                    G = function (n) {
                        for (var e in n) {
                            ...
                            t.value = e, t.innerHTML = n[e], i.inputValue.toString() === e && (t.selected = !0), on.appendChild(t)
                        }
                        T(on), on.focus()
                    };
                    break;
                case"radio":
                    ...
                    rn.innerHTML = "", G = function (n) {
                        for (var e in n) {
                            var o = document.createElement("input"), a = document.createElement("label"), r = document.createElement("span");
                            o.type = "radio", o.name = t.radio, o.value = e, i.inputValue.toString() === e && (o.checked = !0), r.innerHTML = n[e], a.appendChild(o), a.appendChild(r), a.for = o.id, rn.appendChild(a)
                        }
                        T(rn);
                    ...
                    break;
                case"checkbox":
                    var sn = L(u, t.checkbox), ln = r("checkbox");
    ...
    return X.isVisible = function () {
        ...
        var e = d(), o = p();
        if (o) {
            P(o, t.show), E(o, t.hide), clearTimeout(o.timeout), z();
            var a = function () {
                e.parentNode && e.parentNode.removeChild(e), P(document.documentElement, t.shown), P(document.body, t.shown), Z(), Y()
            };
            O && !A(o, t.noanimation) ? o.addEventListener(O, function n() {
                o.removeEventListener(O, n), A(o, t.hide) && a()
        ...
        if (!n || "object" !== (void 0 === n ? "undefined" : I(n)))
    ...
    }, X.version = "6.11.0", X.default = X, X
